export const queryKeys = {
  ...
  childReports: (childId?: string | null) =>
    ["children", childId ?? "none", "reports"] as const,
  penalties: ["penalties"] as const,
  rewards: ["rewards"] as const,
  routines: (childId?: string | null) =>
    ["routines", childId ?? "self"] as const,
  ...
  focusHistory: (childId?: string | null) =>
    ["focus", childId ?? "self"] as const,
